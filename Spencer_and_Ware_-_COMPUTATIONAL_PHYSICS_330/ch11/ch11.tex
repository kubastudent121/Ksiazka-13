...
\ddot{X}=-V' (X)-\dfrac{A(X)}{2\omega ^{2}}\dfrac{dA}{dX}
\end{equation}
	...
	We are not quite finished because we haven't discussed the initial conditions.
...
\end{equation}
	A simple way to find the new equation of motion of the pendulum is to use Einstein's principle of equivalence between acceleration and gravity: If the support
...
\marginpar{
\includegraphics[width=\marginparwidth]{gghd}
\captionof{figure}[] {}\label {Figure 11.1}
} 

\subsection*{P11.1}\label{P11.1}
\begin{enumerate}[label=\alph*]
	\item  Use Matlab's ode45 to solve for the motion of a rapidly driven pendulum by solving both Eq. (\hyperref[11.12]{11.12}) and Eq. (\hyperref[11.14]{11.14}) with $\omega _0 = 1, ~L = 1,
	...
	the agreement again.
	Note: The averaged solution won't go through the middle of the wiggles of the full solution unless you adjust the averaged initial conditions as shown in Eq
