...
\item  Solve \hyperref[6.1]{Eq. 6.1} numerically using Matlab's ODE solver with initial values $x_0 ~= ~1~ and~ v_0 ~=~ 0,~ v_0 ~=~ 1.4,~ and ~v_0~ =~ −1$ and run them from $t = 0 ~to~ ~t = 1$. Overlay the three trajectory plots on your flow plot. Identify
